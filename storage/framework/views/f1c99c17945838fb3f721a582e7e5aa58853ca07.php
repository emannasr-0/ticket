...
//     var receiver_id = activeChat.receiver_id;

//     // Check if both name and receiver_id are non-empty
//     if (name && receiver_id) {
//         $.ajax({
//             type: "get",
//             url: "<?php echo e(url('/admin/message')); ?>" + '/' + receiver_id,
//             data: "",
//             cache: false,
//             dataType: 'json',
...
// $(document).ready(function () {
//     // Fetch messages for all chats on page load
//     $('.user_chat').each(function () {
//         var id = $(this).attr('id');
//         fetchMessages(id, $(this));
//     });

//     // Set up an interval to call the function every 500 seconds
//     setInterval(fetchMessages, 1000);

//     // Your existing click event
//     $('.user_chat').click(function () {
//         // Update activeChat on click
//         activeChat.name = $(this).find('.chat_users').html();
//         activeChat.receiver_id = $(this).attr('id');

//         // Call the fetchMessages function if both name and receiver_id are non-empty
//         if (activeChat.name && activeChat.receiver_id) {
//             fetchMessages();
//         }
//     });
// });
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/anasacad/support.anasacademy.uk/resources/views/admin/chats/index.blade.php ENDPATH**/ ?>