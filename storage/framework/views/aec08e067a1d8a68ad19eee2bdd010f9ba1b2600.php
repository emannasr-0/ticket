                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="description" id="reply_description"
                                        class="form-control <?php echo e(!empty($errors->first('description')) ? 'is-invalid' : ''); ?>" ><?php echo $ticket->description; ?></textarea>
                            ...
                            <form method="post" action="<?php echo e(route('admin.conversion.store', $ticket->id)); ?>"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label class="require form-label"><?php echo e(__('Description')); ?></label>
                                        <textarea name="reply_description" id="reply_description" class="form-control" required></textarea>
                                    ...
                                    <div id="lockAlert" class="alert alert-warning mt-3" role="alert" style="display: none;">
                                      
                                    </div>
                                    
                                    <div class="text-end">
                                        <button id="submitBtn" class="btn btn-primary btn-block mt-2 btn-submit" type="submit">
                            ...
                            <form method="post" action="<?php echo e(route('admin.note.store', $ticket->id)); ?>">
                                ...
                                <div class="card-body adjust_card_width">
                                    <div class="form-group ckfix_height">
                                        <textarea name="note" class="form-control" style="min-height:400px;" id="note"><?php echo e($ticket->note); ?></textarea>
                                        <div class="invalid-feedback">
...
function checkLockStatus() {
    var ticketId = <?php echo e($ticket->id); ?>;

    $.ajax({
        url: 'https://support.anasacademy.uk/admin/check-lock-status/' + ticketId,
        type: 'GET',
        dataType: 'json',
          success: function (response) {
            var lockAlert = $('#lockAlert');
            var takeBtn = $('#takeBtn');
            var submitBtn = $('#submitBtn');

            if (response.locked_by) {
                lockAlert.html('This ticket is currently being handled by ' + response.locked_by + ' <button class="btn btn-primary btn-sm ms-2" onclick="takeTicket()">Take</button>').show();
                takeBtn.show(); // Show the "Take" button
                submitBtn.prop('disabled', true);
            } else {
                lockAlert.hide();
                takeBtn.hide(); // Hide the "Take" button
...
function takeTicket() {
     var ticketId = <?php echo e($ticket->id); ?>;
    window.location.href = 'https://support.anasacademy.uk/admin/take_ticket/'+ ticketId;
}

setInterval(checkLockStatus, 500);
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/anasacad/support.anasacademy.uk/resources/views/admin/tickets/edit.blade.php ENDPATH**/ ?>