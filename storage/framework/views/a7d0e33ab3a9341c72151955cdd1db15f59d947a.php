...
<?php echo $__env->make('admin.template.Header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="auth-wrapper auth-v3">
        ...
        <div class="auth-content">
            ...
            <!--            <img src="<?php echo e($logos.$logo .'?'.time()); ?>" alt="logo">-->
            <!--        </a>-->
                            ...
                            <form method="POST" >
                                ...
                                <div class="card formcontent">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" placeholder="قم بإدخال رقم التذكرة" class="form-control <?php echo e($errors->has('ticket_id') ? 'is-invalid' : ''); ?>" min="0" id="ticket_id" name="ticket_id" placeholder="<?php echo e(__('Enter Ticket Number')); ?>" required="" value="<?php echo e(old('ticket_id')); ?>" autofocus>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="email" placeholder="أدخل عنوان البريد الإلكتروني" class="form-control <?php echo e($errors->has('email') ? 'is-invalid' : ''); ?>" id="email" name="email" placeholder="<?php echo e(__('Email address')); ?>" reuired="" value="<?php echo e(old('email')); ?>">
                                        <div class="invalid-feedback d-block">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/anasacad/support.anasacademy.uk/resources/views/search.blade.php ENDPATH**/ ?>