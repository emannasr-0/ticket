            ...
            <div class="col-xl-12 text-start">
                <div class="mx-3 mx-md-5">
                    <div class="card-header">
                        <h5 class="text-white"><?php echo e(__('Ticket')); ?> - <?php echo e($ticket->ticket_id); ?></h5>
                    </div>
                </div>
                ...
                <div class="card p-4">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <?php $__currentLoopData = $attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="list-group-item px-0">
                                                <?php echo e($attachment); ?><a download="" href="<?php echo e(asset(Storage::url('tickets/'.$ticket->ticket_id."/".$attachment))); ?>" class="edit-icon py-1 ml-2" title="<?php echo e(__('Download')); ?>"><i class="fa fa-download ms-2"></i></a>
                                            </li>
                                ...
                                <?php if(count($attachments)): ?>
                                    <div class="m-1">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <?php $__currentLoopData = $attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="list-group-item px-0">
                                                    <?php echo e($attachment); ?><a download="" href="<?php echo e(asset(Storage::url('reply_tickets/'.$ticket->id."/".$attachment))); ?>" class="edit-icon py-1 ml-2" title="<?php echo e(__('Download')); ?>"><i class="fa fa-download ms-2"></i></a>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                    </div>
                                ...
                                <form method="post" action="<?php echo e(route('home.reply',$ticket->ticket_id)); ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea name="reply_description" id="reply_description" class="form-control <?php echo e($errors->has('reply_description') ? ' is-invalid' : ''); ?>" ><?php echo old('reply_description'); ?></textarea>
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="text-center">
                                            ...
                                            <button class="btn btn-submit btn-primary btn-block mt-2"><?php echo e(__('Submit')); ?></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <?php else: ?>
                        <div class="card">
                            <div class="card-body">
                                <p class="text-blue font-weight-bold text-center mb-0"><?php echo e(__('Ticket is closed you cannot replay.')); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/anasacad/support.anasacademy.uk/resources/views/show.blade.php ENDPATH**/ ?>