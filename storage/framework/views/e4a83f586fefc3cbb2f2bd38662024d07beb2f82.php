                            ...
                            <div class="col-xl-5">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            <?php echo e(Form::label('company', __('Company'), ['class' => 'form-label'])); ?>

                                            <?php echo e(Form::select('company', $companies->pluck('name', 'id'), isset($_GET['company']) ? $_GET['company'] : '', ['class' => 'form-control select'])); ?>
                                    ...
                                    <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            <?php echo e(Form::select('user', $users, isset($_GET['user']) ? $_GET['user'] : '', ['class' => 'form-control select'])); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            style="background: black;">
                                                <?php echo e($ticket->company ? $ticket->company->name : 'No company'); ?>

                                            </span>
                                        </td>
                                        <td><?php echo e($ticket->Group ? $ticket->Group->name : 'No Group'); ?></td>
                                        <td><?php echo e($ticket->user ? $ticket->user->name : 'No User'); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Documents\support\resources\views/admin/tickets/index.blade.php ENDPATH**/ ?>