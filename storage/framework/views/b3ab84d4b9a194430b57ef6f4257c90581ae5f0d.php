            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" action="<?php echo e(route('admin.users.update',$user->id)); ?>" enctype="multipart/form-data">
                        ...
                        <?php if(\Auth::user()->id != $user->id || \Auth::user()->parent == 1): ?>
                        <div class="col-12 form-group">
                            <?php echo e(Form::label('categories', __('Category'),['class'=>'col-form-label'])); ?>

                            <?php echo e(Form::select('categories[]', $categories,$userCatgory, array('class' => 'form-control multi-select ','id'=>'choices-multiple','multiple'=>''))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/anasacad/support.anasacademy.uk/resources/views/admin/users/edit.blade.php ENDPATH**/ ?>