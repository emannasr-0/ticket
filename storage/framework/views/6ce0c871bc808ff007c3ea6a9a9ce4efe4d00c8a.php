...
نحن هنا لتلبية احتياجاتك وضمان راحتك الدراسية</p>
                            ...
                            <div class="justify-content-center btn-section">
                                ...
                                <button>
                                    <a style="text-decoration:none;color:#fff" href="<?php echo e(route('search')); ?>">متابعة طلب سابق</a>
                                </button>
                            </div>
                            <div class="justify-content-center btn-section">
...
<?php /**PATH /home/anasacad/support.anasacademy.uk/resources/views/ticket_created.blade.php ENDPATH**/ ?>