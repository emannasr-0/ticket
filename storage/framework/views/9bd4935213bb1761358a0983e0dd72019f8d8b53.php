...
<form method="post" action="<?php echo e(route('admin.category.update', $category->id)); ?>">
        ...
        <div class="form-group col-md-6">
            ...
            <div class="col-sm-12 col-md-12">
                <input type="text" placeholder="<?php echo e(__('Name of the Category')); ?>" name="name"
                    class="form-control <?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" value="<?php echo e($category->name); ?>"
                    autofocus>
    ...
    <div class="col-12 form-group">
        ...
        <?php echo e(Form::select('users[]', $users, $catgoryuser, ['class' => 'form-control multi-select ', 'id' => 'choices-multiple', 'multiple' => ''])); ?>
...
<?php /**PATH /home/anasacad/support.anasacademy.uk/resources/views/admin/category/edit.blade.php ENDPATH**/ ?>