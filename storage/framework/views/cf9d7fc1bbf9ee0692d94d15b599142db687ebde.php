                                                    ...
                                                    <div class="logo-content logo-set-bg  text-center py-2">
                                                        ...
                                                        <a href="<?php echo e($logos . 'logo-dark.png'); ?>" target="_blank">
                                                            <img id="blah2" alt="your image"
                                                                src="<?php echo e($logos . 'logo-dark.png'.'?'.time()); ?>" width="150px"
                                                                class="logo logo-sm">
                                                        </a>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="logo-content  logo-set-bg text-center py-2">
                                                        <a href="<?php echo e($logos . 'logo-light.png'); ?>" target="_blank">
                                                            <img id="blah3" alt="your image"
                                                                src="<?php echo e($logos . 'logo-light.png'.'?'.time()); ?>" width="150px"
                                                    ...
                                                    <div class="logo-content logo-set-bg text-center py-2">
                                                        <a href="<?php echo e($logos . 'favicon.png'); ?>" target="_blank">
                                                            <img id="blah" alt="your image"
                                                                src="<?php echo e($logos . 'favicon.png'.'?'.time()); ?>" width="80px"
                                                    ...
                                                    <div class="changeLanguage">
                                                        <select name="default_language" id="default_language"
                                                            class="form-select">
                                                             ...
                                                             <option <?php if($lang == $code): ?> selected <?php endif; ?> value="<?php echo e($code); ?>"><?php echo e(Str::ucfirst($language)); ?></option>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4 col-xl-4 col-md-4">
                                                                ...
                                                                <div class="theme-color themes-color">
                                                                    <a href="#!"
                                                                        class="<?php echo e($setting['color'] == 'theme-1' ? 'active_color' : ''); ?>"
                                                                        data-value="theme-1"
                                                                    ...
                                                                    <input type="radio" class="theme_color"
                                                                        ...
                                                                        style="display: none;">
                                                                    <a href="#!"
                                                                        class="<?php echo e($setting['color'] == 'theme-2' ? 'active_color' : ''); ?> "
                                                                        data-value="theme-2"
                                                                    ...
                                                                    <input type="radio" class="theme_color"
                                                                        ...
                                                                        style="display: none;">
                                                                    <a href="#!"
                                                                        class="<?php echo e($setting['color'] == 'theme-3' ? 'active_color' : ''); ?>"
                                                                        data-value="theme-3"
                                                                    ...
                                                                    <input type="radio" class="theme_color"
                                                                        ...
                                                                        style="display: none;">
                                                                    <a href="#!"
                                                                        class="<?php echo e($setting['color'] == 'theme-4' ? 'active_color' : ''); ?>"
                                                                        data-value="theme-4"
                                                                    ...
                                                                    <input type="radio" class="theme_color"
                                                                        ...
                                                                        style="display: none;">
                                                                    <a href="#!"
                                                                        class="<?php echo e($setting['color'] == 'theme-5' ? 'active_color' : ''); ?>"
                                                                        data-value="theme-5"
                                                                    ...
                                                                    <br>
                                                                    <a href="#!"
                                                                        class="<?php echo e($setting['color'] == 'theme-6' ? 'active_color' : ''); ?>"
                                                                        data-value="theme-6"
                                                                    ...
                                                                    <input type="radio" class="theme_color"
                                                                        ...
                                                                        style="display: none;">
                                                                    <a href="#!"
                                                                        class="<?php echo e($setting['color'] == 'theme-7' ? 'active_color' : ''); ?>"
                                                                        data-value="theme-7"
                                                                    ...
                                                                    <input type="radio" class="theme_color"
                                                                        ...
                                                                        style="display: none;">
                                                                    <a href="#!"
                                                                        class="<?php echo e($setting['color'] == 'theme-8' ? 'active_color' : ''); ?>"
                                                                        data-value="theme-8"
                                                                    ...
                                                                    <input type="radio" class="theme_color"
                                                                        ...
                                                                        style="display: none;">
                                                                    <a href="#!"
                                                                        class="<?php echo e($setting['color'] == 'theme-9' ? 'active_color' : ''); ?>"
                                                                        data-value="theme-9"
                                                                    ...
                                                                    <input type="radio" class="theme_color"
                                                                        ...
                                                                        style="display: none;">
                                                                    <a href="#!"
                                                                        class="<?php echo e($setting['color'] == 'theme-10' ? 'active_color' : ''); ?>"
                                                                        data-value="theme-10"
                                                            ...
                                                            <div class="col-lg-4 col-xl-4 col-md-4">
                                                                ...
                                                                <hr class="my-2" />
                                                                <div class="form-check form-switch mt-2">
                                                                    <input type="checkbox" class="form-check-input" id="cust-darklayout" name="cust_darklayout" <?php echo e(!empty($setting['cust_darklayout']) && $setting['cust_darklayout'] == 'on' ? 'checked' : ''); ?> />
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/anasacad/support.anasacademy.uk/resources/views/admin/users/setting.blade.php ENDPATH**/ ?>