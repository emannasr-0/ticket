            ...
            <nav class="navbar navbar-expand-md navbar-light default">
                <div class="container-fluid pe-2">
                    <a class="navbar-brand" href="#">
                        <img src="<?php echo e($logos.$logo .'?'.time()); ?>" alt="logo" style="width:150px;">
                    </a>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/anasacad/support.anasacademy.uk/resources/views/auth/login.blade.php ENDPATH**/ ?>