    ...
    <div class="auth-wrapper auth-v1">
        ...
        <div class="auth-content">
            ...
            <!--                <li class="nav-item nva">-->
                                <!--<a class="nav-link" href="<?php echo e(route('login')); ?>">تسجيل دخول<?php echo e(__('Agent Login')); ?></a>-->
...
<!--                                      </div>-->
                                       ...
                                       <!--         <div class="d-block ">-->
                                       <!--             <a class="btn btn-primary btn-block mt-2 hbtn" id="ticket_button" href="<?php echo e(route('search')); ?>" style="color:#fff"><?php echo e(__('Search Ticket')); ?></a>-->
                                       <!--         </div>-->
                                       <!--          <div class="d-block ">-->
                                       <!--             <a class="btn btn-primary btn-block mt-2 hbtn" id="ticket_button" href="<?php echo e(route('search')); ?>" style="color:#fff"><?php echo e(__('Search Ticket')); ?></a>-->
                                       <!--         </div>-->
                        ...
                        <div id="formcontent" class="col-xl-12 text-center align-self-center">
                           ...
                           <!-- </div>-->
                            ...
                            <div id="rt-card" class="card">
                                <div class="card-body w-100">
                                    <div class="formtitle">
                                        <h2 class="text-primary mb-3"><?php echo e(__('Create Ticket')); ?></h2>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                      ...
                                      <div class="headline"><p>أو يمكنك</p></div>
                                            ...
                                            <!--<div class="text-center">-->
                                            <!--    <div class="d-block ">-->
                                            <!--        <a class="btn btn-primary btn-block mt-2 hbtn" id="ticket_button" href="<?php echo e(route('search')); ?>" style="color:#fff">متابعة طلب سابق</a>-->
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/anasacad/support.anasacademy.uk/resources/views/home.blade.php ENDPATH**/ ?>