...
<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        <a href="<?php echo e(route('admin.company')); ?>" class="list-group-item list-group-item-action border-0 <?php echo e((Request::route()->getName() == 'admin.company' ) ? ' active' : ''); ?>">company <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
...
<?php /**PATH C:\Users\User\Documents\support\resources\views/layouts/setup.blade.php ENDPATH**/ ?>