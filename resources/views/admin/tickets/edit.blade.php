                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="description" id="reply_description"
                                        class="form-control {{ !empty($errors->first('description')) ? 'is-invalid' : '' }}" >{!! $ticket->description !!}</textarea>
                            ...
                            <form method="post" action="{{ route('admin.note.store', $ticket->id) }}">
                                ...
                                <div class="card-body adjust_card_width">
                                    <div class="form-group ckfix_height">
                                        <textarea name="note" class="form-control" style="min-height:400px;" id="note">{{ $ticket->note }}</textarea>
                                        <div class="invalid-feedback">
                                            {{ $errors->first('note') }}
                                        </div>
                                    </div>
