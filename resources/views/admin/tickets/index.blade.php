...
{{-- 
                                    ...
                                    <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::select('company', $companies->pluck('name', 'id'), isset($_GET['company']) ? $_GET['company'] : '', ['class' => 'form-control select']) }}
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            {{ Form::label('user', __('User'), ['class' => 'form-label']) }}
                                            {{ Form::select('user', $users, isset($_GET['user']) ? $_GET['user'] : '', ['class' => 'form-control select']) }}
                                        </div>
                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            style="background: black;">
                                                {{ $ticket->company ? $ticket->company->name : 'No company' }}
                                            </span>
                                        </td>
                                        <td>{{ $ticket->Group ? $ticket->Group->name : 'No Group' }}</td>
                                        <td>{{ $ticket->user ? $ticket->user->name : 'No User' }}</td>
